...
export default function MapPage() {
  ...
  return (
    <>
      <PageHead eyebrow="The county, mapped" title="Where every home, business, and application actually landed."
        stats={[
        ...
        The data the county keeps in siloed portals, on one canvas. Switch layers, filter by year,
        and toggle the growth-area and service boundaries — then click any application to trace its pipeline.
      </PageHead>
      <main className="wrap">
