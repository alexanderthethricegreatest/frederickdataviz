    ...
    <section className="blk">
      ...
      <div className="grid g-2">
        ...
        <Card title="Who dissents most"
          desc={`Share of each member's decisive votes cast against — members with ≥${minApp} recorded votes.`}
        ...
        <Card title="The discretionary docket" wide
          ...
          foot="The thing the Board actually votes on is commercial, industrial, solar and telecom — not the residential growth that drives the fiscal math.">
        ...
        <Card title="Member record" wide
          desc="Recorded votes only. Present rate = share of appearances the member actually cast a vote. Click a name for the full record.">
          <MiniTable open
  ...
  return (
    <>
      <PageHead eyebrow="How they voted" title="Every recorded vote, member by member."
        ...
        Frederick County land-use decisions are made by roll call — the record shows not just the
        outcome but how each supervisor and commissioner voted, when they dissented, when they stepped
        aside, and who tends to vote together. Most votes pass unanimously, so the exceptions — the
        dissents, the recusals, and the cases where the Board overruled its Planning Commission — are
        where the story is.
      </PageHead>

      <main className="wrap">
        {con && <Concordance c={con} />}
        {bos && <BoardSection b={bos} minApp={20} bk="bos" />}
        {pc && <BoardSection b={pc} minApp={5} bk="pc" />}
