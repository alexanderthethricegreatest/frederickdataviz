    ...
    <HomeMotion>
      <section className="hero">
        <div className="wrap hero-grid">
          <div className="hero-lede">
            ...
            <h1>See what growth is doing to Frederick County.</h1>
            <p>Every land-use application, how each one moved through approval, who is building,
               where it gets built, and what it costs the county, assembled from open records the county
               never puts in one place.</p>
            <div className="cta">
              <Magnetic><Link href="/applications" className="btn primary">Browse all {a.applications.total} applications <ArrowRight size={16} /></Link></Magnetic>
              <Magnetic><Link href="/fiscal" className="btn">The fiscal story</Link></Magnetic>
            </div>
          </div>
          ...
          <aside className="ledger" aria-label="Tax base: who pays for growth">
            ...
            <p className="lfoot">The base that pays is under a fifth. Residential develops
               by-right, so the docket officials vote on barely touches it.</p>
          </aside>
        </div>
      </section>
      ...
      <main className="wrap">
        ...
        <section className="blk">
          ...
          <div className="sub">Rezoning approvals go almost entirely to commercial &amp; industrial land. Residential builds by-right on land zoned decades ago.</div>
          <Card title="Rezoning approvals by land class, per year" desc="Acres newly zoned. Residential is near-zero because it needs no rezoning."
            foot="The discretionary docket is all C/I; residential needs no rezoning, so the officials voting on land use rarely see it.">
        ...
        <section className="blk">
          ...
          <div className="sub">Each area, with the full numbers behind it.</div>
          <div className="grid g-3">
            <NavCard href="/map" icon={<MapIcon size={18} />} title="The map"
              blurb="Every home, business, and application on one map. Filter by year, toggle the growth-area and service boundaries."
              stats={[[fmtI(a.consumes.total), "mapped homes"], [fmtI(a.applications.total), "applications"]]} />
            <NavCard href="/fiscal" icon={<Coins size={18} />} title="The money problem"
            ...
            <NavCard href="/land" icon={<TreePine size={18} />} title="Where it gets built"
              blurb="Farmland, karst, floodplain, and how far homes get built ahead of roads and services."
            ...
            <NavCard href="/applications" icon={<Layers size={18} />} title="Application library"
              blurb="Search all 885 cases and open any one to follow it through approval."
